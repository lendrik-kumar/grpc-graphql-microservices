...
func (ec *executionContext) _Account_orders(ctx context.Context, field graphql.CollectedField, obj *Account) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNOrder2ᚕᚖgithubᚗcomᚋlendrikᚑkumarᚋgraphqlᚑgrpcᚑgoᚑmicroservicesᚋgraphqlᚐOrderᚄ,
		true,
		true,
	)
}
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalOOrder2ᚖgithubᚗcomᚋlendrikᚑkumarᚋgraphqlᚑgrpcᚑgoᚑmicroservicesᚋgraphqlᚐOrder,
		true,
		false,
	)
}
...
func (ec *executionContext) marshalNOrder2ᚕᚖgithubᚗcomᚋlendrikᚑkumarᚋgraphqlᚑgrpcᚑgoᚑmicroservicesᚋgraphqlᚐOrderᚄ(ctx context.Context, sel ast.SelectionSet, v []*Order) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNOrder2ᚖgithubᚗcomᚋlendrikᚑkumarᚋgraphqlᚑgrpcᚑgoᚑmicroservicesᚋgraphqlᚐOrder(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNOrder2ᚖgithubᚗcomᚋlendrikᚑkumarᚋgraphqlᚑgrpcᚑgoᚑmicroservicesᚋgraphqlᚐOrder(ctx context.Context, sel ast.SelectionSet, v *Order) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOOrder2ᚖgithubᚗcomᚋlendrikᚑkumarᚋgraphqlᚑgrpcᚑgoᚑmicroservicesᚋgraphqlᚐOrder(ctx context.Context, sel ast.SelectionSet, v *Order) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Order(ctx, sel, v)
