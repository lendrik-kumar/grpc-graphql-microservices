...
func (ec *executionContext) _Account_orders(ctx context.Context, field graphql.CollectedField, obj *Account) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNOrders2ᚕᚖgithubᚗcomᚋlendrikᚑkumarᚋgraphqlᚑgrpcᚑgoᚑmicroservicesᚋgraphqlᚐOrdersᚄ,
		true,
		true,
	)
}
...
func (ec *executionContext) _Orders(ctx context.Context, sel ast.SelectionSet, obj *Orders) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "totalPrice":
			out.Values[i] = ec._Orders_totalPrice(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "products":
			out.Values[i] = ec._Orders_products(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
...
func (ec *executionContext) marshalNOrders2ᚖgithubᚗcomᚋlendrikᚑkumarᚋgraphqlᚑgrpcᚑgoᚑmicroservicesᚋgraphqlᚐOrders(ctx context.Context, sel ast.SelectionSet, v *Orders) graphql.Marshaler {
	return ec._Orders(ctx, sel, v)
}

func (ec *executionContext) marshalNOrders2ᚕᚖgithubᚗcomᚋlendrikᚑkumarᚋgraphqlᚑgrpcᚑgoᚑmicroservicesᚋgraphqlᚐOrdersᚄ(ctx context.Context, sel ast.SelectionSet, v []*Orders) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNOrders2ᚖgithubᚗcomᚋlendrikᚑkumarᚋgraphqlᚑgrpcᚑgoᚑmicroservicesᚋgraphqlᚐOrders(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
